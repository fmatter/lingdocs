...
\glb \gl{aux}-\gl{pl} begin-\gl{nmlz}-\gl{pl} \gl{3}-say-\gl{rem}.\gl{cont}-\gl{pl} \gl{aff} \gl{3}>\gl{3}-son-\gl{pert} daughter-\gl{pert} \gl{3}\gl{poss}-wife \gl{rel} \gl{pl} \gl{3}>\gl{3}-mock-\gl{nmlz}=\gl{ins} \gl{ideo}.laugh \gl{3}-say-\gl{rem}.\gl{cont}-\gl{pl} \gl{aff}//
